        ...
        <div className="relative z-10 w-full">
          <div className="mx-auto max-w-7xl px-6 lg:px-12">
            <div className="max-w-3xl">
              {/* Badge */}
              <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-5 py-2 backdrop-blue-xl">
              ...
              <p className="mt-6 max-w-2xl text-lg leading-relaxed text-white/70">
                Discover your dream home as luxury apartments, modern homes with our curated selection of premium properties.
              </p>
